// Worker Cloudflare — arome-proxy
// Proxy CORS pour l'API WMS AROME Prévision Immédiate de Météo-France
// Repo GitHub : arome-proxy
// Déployé sur : https://arome-proxy.bounes-v.workers.dev
...
export default {
  async fetch(request) {
    ...
    try {
      ...
      // Cache 5 min pour les tuiles images, pas de cache pour GetCapabilities
